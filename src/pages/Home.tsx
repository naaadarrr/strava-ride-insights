      ...
      <div className="space-y-12 pb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">{t('home.stats.title')}</h2>
          ...
          >
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">{t('home.activities.title')}</h2>
              <p className="text-gray-600 dark:text-gray-400">
