    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div className={cn("rounded-xl p-6 shadow-sm", "bg-white dark:bg-gray-800")}>
        <div className="flex items-center space-x-3">
          ...
          <div>
            <div className={cn("text-sm", "text-gray-500 dark:text-gray-400")}>{t('stats.overview.total_rides')}</div>
            <div className={cn("text-2xl font-semibold", "text-gray-900 dark:text-gray-100")}>{stats.total_activities}</div>
          </div>
        </div>
      </div>
      ...
      <div className={cn("rounded-xl p-6 shadow-sm", "bg-white dark:bg-gray-800")}>
        <div className="flex items-center space-x-3">
          ...
          <div>
            <div className={cn("text-sm", "text-gray-500 dark:text-gray-400")}>{t('stats.overview.total_time')}</div>
      ...
      <div className={cn("rounded-xl p-6 shadow-sm", "bg-white dark:bg-gray-800")}>
        <div className="flex items-center space-x-3">
          ...
          <div>
            <div className={cn("text-sm", "text-gray-500 dark:text-gray-400")}>{t('stats.total_elevation')}</div>
            <div className={cn("text-2xl font-semibold", "text-gray-900 dark:text-gray-100")}>
