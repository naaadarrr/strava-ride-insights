...
import type { DetailedActivity } from '../types/strava';
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6 mt-4">
          <div className="flex flex-col space-y-1">
            <div className="flex items-center text-gray-600 dark:text-gray-400">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">{t('activities.card.distance')}</p>
            </div>
          ...
          <div className="flex flex-col space-y-1">
            <div className="flex items-center text-gray-600 dark:text-gray-400">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">{t('activities.card.duration')}</p>
            </div>
            <p className="font-semibold text-gray-900 dark:text-white">
          ...
          <div className="flex flex-col space-y-1">
            <div className="flex items-center text-gray-600 dark:text-gray-400">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">{t('activities.card.elevation')}</p>
            </div>
            <p className="font-semibold text-gray-900 dark:text-white">
          ...
          <div className="flex flex-col space-y-1">
            <div className="flex items-center text-gray-600 dark:text-gray-400">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">{t('activities.card.speed')}</p>
            </div>
            <p className="font-semibold text-gray-900 dark:text-white">
          ...
          {activity.average_heartrate && (
            <div className="flex flex-col space-y-1">
              <div className="flex items-center text-gray-600 dark:text-gray-400">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">{t('activities.card.heartRate')}</p>
              </div>
              <p className="font-semibold text-gray-900 dark:text-white">
          ...
          <div className="flex flex-col space-y-1">
            <div className="flex items-center text-gray-600 dark:text-gray-400">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">{t('activities.card.date')}</p>
            </div>
            <p className="font-semibold text-gray-900 dark:text-white">
